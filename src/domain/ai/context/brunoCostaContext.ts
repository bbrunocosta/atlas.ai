...
- *Outros:* Tailwind CSS, Docker, Desenvolvimento de SaaS, Scrum, API de ASP.NET para Web  
...
### *Sênior Full Stack Engineer*  
*IntellectaScore*  
📍 São Paulo, Brasil  
📅 jan. de 2024 - nov. de 2024 (*11 meses*)  

- Responsável pelo *ciclo completo de desenvolvimento* da plataforma de *testes de QI*.
- Implementação de *arquitetura escalável na AWS* utilizando *AWS Lambda e DynamoDB*.
- Integração de *soluções de pagamento*, incluindo *Mercado Pago e PayPal*.
- Desenvolvimento *front-end* com *Nuxt.js, TailwindCSS e Nuxt UI*.
- Criação de *scripts ETL* para análise de métricas no *Power BI*.
...
*Localize*  
📍 São Paulo, Brasil  
📅 set. de 2021 - out. de 2024 (*3 anos e 2 meses*)  

- Desenvolvimento de um *sistema investigativo do zero*.
- Definição da *arquitetura, banco de dados e infraestrutura*.
- Implantação de *IA para automação da leitura de documentos*.
- Realização de *testes unitários e revisão de código*.
- *Onboarding e mentoria* de novos desenvolvedores.
...
- Desenvolvimento de um *site responsivo e interativo*.
- Integração de *vídeos do Vimeo*.
- Manipulação avançada de *imagens e efeitos visuais*.
...
📅 out. de 2020 - jan. de 2021 (*4 meses*)  

- Atuação no *desenvolvimento estratégico* de startups.
- Construção de *decks para investidores*.
